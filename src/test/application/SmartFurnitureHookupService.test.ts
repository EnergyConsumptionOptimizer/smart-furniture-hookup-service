...
describe("SmartFurnitureHookupService", () => {
  ...
  describe("getSmartFurnitureHookups", () => {
    ...
    it("should return the smart furniture hookup from the repository", async () => {
      await repository.addSmartFurnitureHookup(mockSmartFurnitureHookupFridge);
      await repository.addSmartFurnitureHookup(mockSmartFurnitureHookupHeater);
      await repository.addSmartFurnitureHookup(mockSmartFurnitureHookupLamp);
  ...
  describe("getSmartFurnitureHookup", () => {
    ...
    beforeEach(async () => {
      repository.clear();
      smartFurnitureHookup = await repository.addSmartFurnitureHookup(
        mockSmartFurnitureHookupLamp,
      );
    });
  ...
  describe("updateSmartFurnitureHookup", () => {
    ...
    it("should throw SmartFurnitureHookupNameConflictError when new name conflicts", async () => {
      const newSmartFurnitureHookup = await repository.addSmartFurnitureHookup(
        mockSmartFurnitureHookupFridge,
      );
